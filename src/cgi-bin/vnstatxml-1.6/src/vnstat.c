...
int main(int argc, char *argv[]) {
	...
	/* set the default configuration for vnStatXML*/
	...
	for (currentarg=1; currentarg<argc; currentarg++) {
		...
		if (strcmp(argv[currentarg],"--longhelp")==0) {
			...
			/* Added by Wu Zhangjin at Sat Jun 28 04:27:03 CST 2008 */
			printf("         --dumpxml             show database in XML format\n");		
			printf("                                                                   \n");
			printf("	 This option is new for dumping the summary,day,hour,month,\n");
			printf("	 top10 data info in XML format, you can use it like this:  \n");
			printf("                                                                   \n");
			printf("         $ vnstat --dumpxml -i IFACE [no option]|-d|-h|-m|-t       \n");		
		...
		/* Added by Wu Zhangjin at Sat Jun 28 04:12:56 CST 2008 */
